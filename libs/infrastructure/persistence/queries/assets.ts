import "server-only";
/**
 * Patrimoine read models: what is owned and owed, whose it is, and how the
 * total has moved. The writes are `@application/assets`.
 */
...
import { applyOwnedScope } from "./scope";
