import "server-only";
/**
 * Apport read models: what each person owes the joint account, and whether it
 * landed. Reconciliation arithmetic over matched transactions, shaped for a
 * screen. The writes are `@application/contributions`.
 */
