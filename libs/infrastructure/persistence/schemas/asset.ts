...
export const AssetEntity = new EntitySchema<AssetRow>({
  ...
  columns: {
    ...
    surfaceM2: { name: "surface_m2", type: Number, nullable: true },
    landM2: { name: "land_m2", type: Number, nullable: true },
    propertyKind: { name: "property_kind", type: "text", nullable: true },
    propertyCondition: { name: "property_condition", type: "text", nullable: true },
